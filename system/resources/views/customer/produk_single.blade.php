      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 mb-5 ftco-animate">
            <a href="{{asset('public')}}/images/vantela.jpg" class="image-popup"><img src="{{asset('public')}}/images/vantela.jpg" class="img-fluid" alt="Colorlib Template"></a>
          </div>
          <div class="col-lg-6 product-details pl-md-5 ftco-animate">
            ...
            <p><a href="{{url('checkout')}}" class="btn btn-black py-3 px-5">Add to Cart</a></p>
          </div>
        </div>
      </div>
     </section>
