...
Route::get('setting', [SettingController::class, 'store']);
...
Route::get('customer/produk', [ClientProdukController::class, 'produk']);
Route::post('customer/produk/filter', [ClientProdukController::class, 'filter']);

Route::post('home/filter', [ClientProdukController::class, 'filter']);
...
Route::get('/produk_single', function () {
    return view('customer.produk_single');
});
